...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main-header {
            background-color: var(--card-bg); padding: 1rem 0; border-bottom: 1px solid #333; position: sticky; top: 0; z-index: 1000;
        }
        .main-header .container { display: flex; justify-content: space-between; align-items: center; }
        .logo { font-size: 1.8rem; font-weight: 900; color: var(--text-color); text-decoration: none; }
        ...
        .header-icons a span { position: absolute; top: -8px; right: -10px; background-color: #ff7300; color: white; font-size: 0.7rem; border-radius: 50%; padding: 2px 5px; }
        ...
        .main-footer { background-color: var(--card-bg); padding: 3rem 0 1rem; border-top: 1px solid #333; }
        .footer-content { display: grid; grid-template-columns: 1fr; gap: 2rem; text-align: center; margin-bottom: 2rem; }
        .footer-section h4 { font-size: 1.2rem; margin-bottom: 1rem; color: var(--primary-color); }
        .footer-section { color: #000000; }
        .footer-section ul { list-style: none; padding: 0; }
        .footer-section ul li a { color: var(--text-muted); text-decoration: none; }
        .social-icons a { color: var(--text-color); font-size: 1.5rem; margin: 0 10px; }
        .footer-bottom { text-align: center; padding-top: 1rem; border-top: 1px solid #333; color: var(--text-muted); }
    ...
    <footer class="main-footer">
        <div class="container">
            <div class="footer-content">
                <div class="footer-section"><h4>Perigo Tech</h4><p>A sua paixão por hardware começa aqui.</p></div>
            ...
            <div class="checkout-wrapper">
                ...
                <section class="form-section">
                    ...
                    <div class="form-grupo">
                     ...
                     <div class="form-grupo">
                        ...
                        <input type="text" id="endereco" name="endereco" required placeholder="Av. Principal, 123, Centro">
                    </div>
                    ...
                    <div class="form-grupo" style="display: flex; gap: 1rem;">
                        <div style="flex: 2;">
                            ...
                            <input type="text" id="validade" name="validade" placeholder="MM/AA" 
                                   required maxlength="5" onkeyup="formatarData(this)">
                        </div>
                        <div style="flex: 1;">
                ...
                <section class="summary-section">
                    ...
                    <div class="resumo-total">
                        <span>Total</span>
                        <strong id="display-total-valor">R$ <?php echo number_format($total_geral, 2, ',', '.'); ?></strong>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            parcelasInputs.forEach(input => {
                input.addEventListener('change', function() {
                    if (this.checked) {
                        const novoTextoTotal = this.dataset.textoTotal;
