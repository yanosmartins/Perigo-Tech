...
<style>
    * { margin:0; padding:0; box-sizing:border-box; font-family:Poppins,sans-serif; }
    ...
    @media(max-width:700px){
        .container { grid-template-columns: 1fr; max-width:90%; }
...
<div>
    ...
    <form class="container" method="POST" action="atualizar_cliente.php">
        <input type="hidden" name="idusuarios" value="<?php echo $user_data['idusuarios']; ?>">
        ...
        <div>
            ...
            <input type="date" name="data_nasc" value="<?php echo $user_data['data_nasc']; ?>">
        </div>
        ...
        <div>
            <label>Senha</label>
            <input type="password" name="senha" value="<?php echo htmlspecialchars($user_data['senha']); ?>" required>
        </div>
