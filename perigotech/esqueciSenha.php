...
if (isset($_POST['alterar'])) {
    ...
    if (empty($login) || empty($nova_senha) || empty($confirma_senha)) {
        ...
        $sql = "SELECT idusuarios FROM cadastro_tech WHERE login = ?";
        ...
        if ($stmt->num_rows > 0) {
            ...
            $sql_update = "UPDATE cadastro_tech SET senha = ? WHERE idusuarios = ?";
            $stmt_update = $conexao->prepare($sql_update);
            $stmt_update->bind_param("si", $nova_senha, $id);
...
<div class="form-container">
    ...
    <p style="text-align:center;"><a href="login.php" style="color:#ff7300;">Voltar ao Login</a></p>
</div>
